...
$validator = new PrintProviderReferenceClient_Validator_ReceiveUpdateValidator();
$processor = new PrintProviderReferenceClient_Processor_NullProcessor();
$receiverClass = new PrintProviderReferenceClient_Receive_Update($validator, $processor);
