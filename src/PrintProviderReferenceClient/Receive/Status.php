...
Class PrintProviderReferenceClient_Receive_Status {
    ...
    /**
     * @param PrintProviderReferenceClient_Validator_ReceiveStatusValidator $validator
     * @param PrintProviderReferenceClient_Processor_ProcessorInterface $processor
     */
    public function __construct(PrintProviderReferenceClient_Validator_ReceiveStatusValidator $validator, PrintProviderReferenceClient_Processor_ProcessorInterface $processor)
    {
